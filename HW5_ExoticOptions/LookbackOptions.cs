...
{
    public class LookbackOptions:Simulator 
    {
        ...
        public double[] OptionList()
        {
            ...
            if (IsDeltaCV == true)
            {
                ...
                if (Iscall == true)
                {
                    for (int i = 0; i < Nsim; i++)
                    {
                        OptList[i] = Math.Max(S_max[i] - K, 0) + beta1 * CVMatrix[i, Steps];
                    }
                }
                else
                {
                    ...
                    for (int i = 0; i < Nsim; i++)
                    {
                        OptList[i] = Math.Max(K - S_min[i], 0) + beta1 * CVMatrix[i, Steps];
            ...
            else
            {
                if (Iscall == true)
                {
                    ...
                    for (int i = 0; i < Nsim; i++)
                    {
                        OptList[i] = Math.Max(S_max[i] - K, 0);
                ...
                else
                {
                    for (int i = 0; i < Nsim; i++)
                    {
                        OptList[i] = Math.Max(K - S_min[i], 0);
        ...
        public double GetDelta()
        {
            ...
            #region instance 1
            LookbackOptions E1 = new LookbackOptions();
            ...
            #region instance 2
            LookbackOptions E2 = new LookbackOptions();
