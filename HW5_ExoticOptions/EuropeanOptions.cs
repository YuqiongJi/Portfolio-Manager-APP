...
{
    public class EuropeanOptions:Simulator
    {
            ...
            public double[] OptionList()
            {
                ...
                if (IsDeltaCV == true)
                {
                    ...
                    if (Iscall == true)
                    {
                        ...
                        {
                            OptList[i] = Math.Max(S[i, Steps] - K, 0) + beta1 * CVMatrix[i, Steps];
                        }
                    }
                    else
                    {
                        ...
                        for (int i = 0; i < Nsim; i++)
                        {
                            OptList[i] = Math.Max(K - S[i, Steps], 0) + beta1 * CVMatrix[i, Steps];
                ...
                else
                {
                    if (Iscall == true)
                    {
                        ...
                        for (int i = 0; i < Nsim; i++)
                        {
                            OptList[i] = Math.Max(S[i, Steps] - K, 0);
                    ...
                    else
                    {
                        for (int i = 0; i < Nsim; i++)
                        {
                            OptList[i] = Math.Max(K - S[i, Steps], 0);
            ...
            public double GetDelta()
            {
                ...
                #region instance 1
                EuropeanOptions E1 = new EuropeanOptions();
                ...
                #region instance 2
                EuropeanOptions E2 = new EuropeanOptions();
