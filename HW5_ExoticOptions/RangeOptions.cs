...
{
    public class RangeOptions:Simulator
    {
        ...
        public double[] OptionList()
        {
            ...
            if (IsDeltaCV == true)
            {
                for (int i = 0; i < Nsim; i++)
                {
                    OptList[i] = S_max[i] - S_min[i] + beta1 * CVMatrix[i, Steps];
                }
        ...
        public double GetDelta()
        {
            ...
            #region instance 1
            RangeOptions E1 = new RangeOptions();
            ...
            #region instance 2
            RangeOptions E2 = new RangeOptions();
